    ...
    {  
    	...
    	{  
    		...
    		WatchService service = FileSystems.getDefault().newWatchService();	// Create a WatchService
    	       Path path = Paths.get("/home/rahul/DATASET");	// Get the directory to be monitored
    	       path.register(service,StandardWatchEventKinds.ENTRY_CREATE);	// Register the directory
    	       ...
    	       while(true)
    	       {
    	          ...
    	          for (WatchEvent event : key.pollEvents())
    	          {
    	        	 ...
    	        	 dout.writeUTF("/home/rahul/DATASET/"+event.context().toString()); 
    	             dout.flush();
    	          }
